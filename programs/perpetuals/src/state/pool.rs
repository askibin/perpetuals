...
impl Pool {
    ...
    pub fn get_swap_price(
        ...
        let min_price = std::cmp::min(token_in_price, token_in_ema_price);
        let max_price = std::cmp::max(token_out_price, token_out_ema_price);
    ...
    pub fn get_swap_amount(
        ...
        let swap_price = self.get_swap_price(token_in_price, token_out_price, custody_in)?;
    ...
    fn get_price(
        ...
        if side == Side::Long {
            let max_price = std::cmp::max(token_price, token_ema_price);
            Ok(OraclePrice {
            ...
            let min_price = std::cmp::min(token_price, token_ema_price);
            Ok(OraclePrice {
    ...
    fn get_fee(
        ...
        if custody.fees.mode == FeesType::Linear {
